...
public class PetTest {
    ...
    void equalsPositiveTest() {
        Dog pet = new Dog("Rock", 5, 75, new String[]{"eat", "drink", "sleep"});
        Dog pet1 = new Dog("Rock", 5, 75, new String[]{});
    ...
    void hashNegativeTest() {
        Dog pet = new Dog("Bob", 2, 40, new String[]{"eat", "drink", "sleep"});
        Pet pet1 = new DomesticCat("Bo", 2, 40, new String[]{});
        Pet pet2 = new DomesticCat("Bob", 22, 40, new String[]{});
        Pet expected = new DomesticCat("Bob", 2, 40, new String[]{});
    ...
    void equalsNegativeTest() {
        Dog pet = new Dog("Bob", 2, 40, new String[]{"eat", "drink", "sleep"});
        Fish pet1 = new Fish("Bo", 2, 40, new String[]{});
        Fish pet2 = new Fish("Bob", 22, 40, new String[]{});
        Fish expected = new Fish("Bob", 2, 40, new String[]{});
