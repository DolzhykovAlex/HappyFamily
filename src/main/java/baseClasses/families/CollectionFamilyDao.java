...
public class CollectionFamilyDao implements Dao<Family> {
    ...
    public CollectionFamilyDao() {
        Man human1M = new Man("Obama", "Bal", 1983, 180);
        Woman human1W = new Woman("Sweet", "Bal", 1984, 190);
        Family family1 = new Family(human1W, human1M);
        Man human2M = new Man("Jorge", "Bush", 1983, 140);
        Woman human2W = new Woman("Hilary", "Bush", 1984, 170);
        Family family2 = new Family(human2W, human2M);
        Man human3M = new Man("Mike", "Tyson", 1983, 160);
        Woman human3W = new Woman("Agata", "Tyson", 1989, 175);
        Family family3 = new Family(human3W, human3M);
        Man human4M = new Man("Alex", "Black", 1983, 160);
        Woman human4W = new Woman("Agata", "Black", 1989, 174);
